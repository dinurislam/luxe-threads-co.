      ...
      <div className="flex items-center justify-between px-6 lg:px-12 h-16">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link
            ...
            className="text-[11px] uppercase tracking-premium font-body text-muted-foreground hover:text-foreground ghost-slide"
          >
            Shirts
          </Link>
          <Link
        ...
        <Link to="/" className="absolute left-1/2 -translate-x-1/2">
          <h1 className="font-display text-lg lg:text-xl tracking-tight uppercase">
            On Items Zone
          </h1>
        </Link>
        ...
        <div className="flex items-center gap-6 ml-auto">
          <button
            ...
            className="text-muted-foreground hover:text-foreground ghost-slide"
            aria-label="Search"
          >
          ...
          <Link
            to="/account"
            className="hidden md:block text-muted-foreground hover:text-foreground ghost-slide"
            aria-label="Account"
          >
