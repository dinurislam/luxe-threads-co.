...
const Shop = () => {
  ...
  }, [categoryFilter, selectedSizes, priceRange, searchQuery]);
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className={`text-xs text-left font-body ghost-slide ${!categoryFilter ? "text-foreground" : "text-muted-foreground"}`}
              >
                All
              </button>
              {categories.map((cat) => (
                <button
                  ...
                  className={`text-xs text-left font-body ghost-slide ${categoryFilter === cat.slug ? "text-foreground" : "text-muted-foreground"}`}
                >
                  {cat.name}
                </button>
              ))}
            ...
            <div className="flex flex-wrap gap-2">
              {SIZES.map((size) => (
                <button
                  ...
                  className={`text-[10px] uppercase tracking-premium px-3 py-1.5 border ghost-slide ${
